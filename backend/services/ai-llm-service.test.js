...
test('LLM request body enables thinking without effort controls and requires Chinese reason output', () => {
...
test('LLM request timeout is ten seconds', () => {
  assert.equal(aiLlmService._requestTimeoutMs(), 10000);
});
