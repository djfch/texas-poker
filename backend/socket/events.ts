/**
 * backend/socket/events.ts - Socket Event Definitions
 *
 * Centralized event names for Socket.IO communication.
 */

// Index signature keeps legacy fallback lookups (e.g. EVENTS.SERVER.CONNECTED)
// compiling without changing the emitted runtime shape.
interface EventGroup {
  [key: string]: string;
}

// Client -> Server
const CLIENT: EventGroup = {
  JOIN_ROOM: 'room:join',
