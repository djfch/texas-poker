/**
 * backend/domain/card.test.ts
 *
 * Unit tests for Card entity.
 * Run with: node --import tsx --test backend/domain/card.test.ts
 */

import { test, describe } from 'node:test';
import assert from 'node:assert';
import { Card, SUITS, RANKS, displayCard, displayCards, isRed, isBlack } from './card';
